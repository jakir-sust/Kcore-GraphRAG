...
async def run_workflow(
    ...
    output["entity_ids"] = output["entity_ids"].apply(lambda x: list(x) if hasattr(x, "__iter__") else x)
    output["relationship_ids"] = output["relationship_ids"].apply(lambda x: list(x) if hasattr(x, "__iter__") else x)
